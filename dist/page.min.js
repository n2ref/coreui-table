...
$(document).ready(function(){$("#page-theme").find("button").click(function(){"light"===$(this).data("bs-theme-value")?($("html").removeAttr("data-bs-theme"),$("#page-theme .nav-link").html('<i class="bi bi-sun"></i>')):($("html").attr("data-bs-theme","dark"),$("#page-theme .nav-link").html('<i class="bi bi-moon-stars"></i>'))}),$("pre code").each(function(t,e){hljs.highlightBlock(e)})});
