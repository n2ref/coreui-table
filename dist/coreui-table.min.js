...
var coreuiTableUtils={eval:function(code){!function(){eval(code)}()}};;
...
CoreUI.table.columns.switch={_table:null,_options:{type:"switch",label:"",field:"",width:5,valueY:"Y",valueN:"N",attr:{class:"coreui-table__switch_container"},attrHeader:{},onChange:null},init:function(s,t){this._table=s,this._options=$.extend(!0,{},this._options,t);let c=this,e="#coreui-table-"+s._options.id+" > .coreui-table__container > .coreui-table__wrapper > table > tbody > tr.coreui-table__record > td.coreui-table__switch_container";this._table.on("show-records.coreui.table",function(){$(e).click(function(t){t.stopPropagation()}),!c._options.hasOwnProperty("onChange")||"function"!=typeof c._options.onChange&&"string"!=typeof c._options.onChange||$(e+' .coreui-table__switch[data-field="'+c._options.field+'"]').change(function(t){var e,o=$(this).val(),i=$(this).is(":checked"),o=s._getRecordByKey(o);let n=!0;return"function"==typeof c._options.onChange?n=c._options.onChange(o,i):"string"==typeof c._options.onChange&&(e=new Function("record","checked",c._options.onChange),n=e(o,i)),n||$(this).prop("checked",!i),!1})})},getOptions:function(){return this._options},render:function(t,e,o){return'<div class="form-switch"><input class="coreui-table__switch form-check-input" type="checkbox" value="'+o+'"'+(e.hasOwnProperty(this._options.field)&&e[this._options.field]===this._options.valueY?' checked="checked"':"")+' data-field="'+this._options.field+'" data-field="'+this._options.field+'"></div>'}};;
